...
from STIP_computation import compute_structure_tensor, compute_derivatives, compute_harris_response, detect_interest_points
import csv
...
if __name__ == "__main__":
    ...
    VIDEOS = "/content/drive/MyDrive/Sets/Train_STIP_P2/"  # Cambia la ruta!!!!!
    os.makedirs(output_dir, exist_ok=True)

    #Cargar los paths de los videos.
    video_paths = load_paths(VIDEOS)
